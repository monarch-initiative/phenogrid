...
window.onload = function() {
    ...
    Phenogrid.createPhenogridForElement(document.getElementById('phenogrid_container3'), {
        ...
        targetGroupList: [
            {name: "Homo sapiens", id: "9606", crossComparisonView: true, active: true},
            {name: "Mus musculus", id: "10090", crossComparisonView: false, active: true},
            {name: "Danio rerio", id: "7955", crossComparisonView: false, active: false}
       ]
    });
    ...
    Phenogrid.createPhenogridForElement(document.getElementById('phenogrid_container4'), {
        ...
        targetGroupList: [
            {name: "Homo sapiens", id: "9606", crossComparisonView: false, active: true},
            {name: "Mus musculus", id: "10090", crossComparisonView: false, active: true},
            {name: "Danio rerio", id: "7955", crossComparisonView: false, active: true}
       ]
    });
    ...
    Phenogrid.createPhenogridForElement(document.getElementById('phenogrid_container5'), {
        ...
        targetGroupList: [
            ...
            {name: "Mus musculus", id: "10090", crossComparisonView: true, active: true},
            {name: "Danio rerio", id: "7955", crossComparisonView: false, active: true},
            {name: "Drosophila melanogaster", id: "7227", crossComparisonView: true, active: true}
       ]
    });
}
</script>

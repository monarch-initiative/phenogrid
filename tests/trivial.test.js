...
describe('our testing environment for is sane', function(){
    ...
    // it('I can see phenogrid from my porch', function(){
    // 	var phenogrid = require('..');
    // 	assert.typeOf(phenogrid, 'object');
    // });
...
describe('our testing environment for model is sane', function(){

    // Can I pull in the "libraries"?
    it('I can see model from my porch', function(){
